            ...
            <motion.div variants={fadeBottom} initial="hidden" animate="visible" className="flex flex-wrap justify-around w-full px-16">
                ...
                <Link to='/class1'>
                    <motion.div variants={fadeItem} className="m-8 w-80 h-64 cursor-pointer">
                        ...
                        <div className="-pr-2 ml-20 -mt-36 text-4xl font-semibold text-white transition duration-500 transform font-sourceSerifPro hover:scale-105">Chemistry</div>
                    </motion.div>
                </Link>
                ...
                <Link to='/class1'>
                    <motion.div variants={fadeItem} className="m-8 w-80 h-64 cursor-pointer">
                        <img className="transition duration-500 transform border-4 border-blue-600 rounded-lg hover:scale-110" alt="" src={SubjectImg} />
                        <div className="ml-20 -mt-36 text-5xl font-semibold text-white transition duration-500 transform font-sourceSerifPro hover:scale-105">Biology</div>
                    </motion.div>
                </Link>
                ...
                <Link to='/class1'>
                    <motion.div variants={fadeItem} className="m-8 w-80 h-64 cursor-pointer">
                        <img className="transition duration-500 transform border-4 border-blue-600 rounded-lg hover:scale-110" alt="" src={SubjectImg} />
                        <div className="ml-20 -mt-36 text-4xl font-semibold text-white transition duration-500 transform font-sourceSerifPro hover:scale-105">Aerospace</div>
                    </motion.div>
                </Link>
