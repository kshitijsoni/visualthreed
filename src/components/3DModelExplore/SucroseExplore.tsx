...
function Model(props: JSX.IntrinsicElements['group']) {
    ...
    const { nodes } = useGLTF('/sucrose/scene.gltf') as GLTFResult
...
export default function SucroseExplore() {
            ...
            <div className="pt-20 bg-ARbg">
                ...
                <div className="grid w-full place-items-center">
                    <motion.div variants={fadeLogo} initial="hidden" animate="visible" className="grid py-8 w-full place-items-center text-center">
                        ...
                        <div className="inline-flex h-1 bg-indigo-500 rounded-full w-32"></div>
                    </motion.div>
