...
const Model = () => {
    const gltf = useLoader(GLTFLoader, "/Water/scene.gltf");
    return (
        <>
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-2">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <div className="grid justify-center grid-cols-1 gap-6 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
                                <img className="flex p-6 text-6xl rounded-xl h-64 w-64" src="https://storage.echoar.xyz/wispy-violet-4999/615f4581-7690-4cc7-89a2-1f1c51e961f1" alt="Water QR" />
