...
export default function spaceistryModels({ spaceData }) {
        ...
        <div className="pt-20 md:pt-24 text-white">
            ...
            <motion.div variants={fade} initial="hidden" animate="visible" className="md:col-span-2">
                ...
                <div className="grid w-full py-10 place-items-center">
                    ...
                    <div className="font-fontVollkorn text-justify text-xl w-86 mt-2 mx-4 md:mx-44">{spaceData.ModelDetails}</div>
                </div>
                    ...
                    <div className="w-full h-128 px-8 md:px-4 outline-none cursor-grab md:col-span-2 lg:block">
                        <Canvas shadows dpr={[1, 2]} camera={{ position: [0, 0, 4], fov: 50 }}>
                            ...
                            <Suspense fallback={<Loader />}>
                                <Model path={spaceData.ModelPath} size={spaceData.ModelSize} />
                    ...
                    <div className="mt-16 md:mt-0 md:col-span-1 p-4">
                        <div className="h-full md:flex md:flex-col md:justify-center">
                            ...
                            <div className="grid place-items-center pb-8 mx-8">
                                <Image src={spaceData.QrCodeUrl} width="250" height="250" alt="Molecule QR" className="flex p-6 text-6xl rounded-xl h-48 w-48" />
                                <a href={spaceData.ARlink} target="_blank" rel="noreferrer">
...
export async function getStaticPaths() {
    ...
    const paths = spaceInfo.map((spaceData) => ({
        params: { spaceSubject: spaceData.SpaceSubject }
    }));
...
export async function getStaticProps({ params }) {
    const { spaceSubject } = params;
    const spaceData = spacePageInfo.find((p) => p.SpaceSubject === spaceSubject);
