    ...
    if (snap.current === "body") {
        ...
        return (
            <div className="h-full md:flex md:flex-col md:justify-center">
                ...
                <h1 className="text-xl">Dragons trunk not only carries unpressurized cargo but also supports the spacecraft during ascent. One half of the trunk is covered in solar panels that provide power to Dragon during flight and while on-station. The trunk remains attached to Dragon until shortly before reentry into Earths atmosphere.</h1>
            </div>
        )
    }
    else {
    ...
    return (
        <>
            <div className="pt-8 md:pt-24 text-white">
                ...
                <Link href="/subject/aeronautics" passHref><span className="ml-8 cursor-pointer">Go Back</span></Link>
